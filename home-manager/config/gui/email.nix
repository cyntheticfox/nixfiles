{ config, pkgs, lib, ... }: {
  ...
  xdg.configFile."astroid/keybindings".text = ''
    ...
    main_window.close_page=d # Close mode (or window if other windows are open), default: C-w
    main_window.close_page_force=D # Force close mode (or window if other windows are open), default: C-W
    ...
    thread_index.close_pane=d # Close thread view pane if open, default: C-w
